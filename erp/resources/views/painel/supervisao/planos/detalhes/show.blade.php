        ...
        <div id="kt_content_container" class="container-xxl" data-select2-id="select2-data-kt_content_container">
                ...
                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10" data-select2-id="select2-data-133-xwcd">
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row fv-plugins-icon-container">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="name" class="form-control mb-2" placeholder="Nome do detalhe" value="{{ $detail->name }}" disabled>
                                <!--end::Input-->
                                <!--begin::Description-->
                            ...
                            <div>
                                ...
                                <div class="d-flex fv-row">
                                    ...
                                    <div class="form-check form-check-custom form-check-solid">
                                        <!--begin::Input-->
                                        <input class="form-check-input me-3" name="status" type="radio" value="ativo" id="kt_ecommerce_add_category_automation_1" @if($detail->status === 'ativo') checked="checked" @endif disabled>
                                        <!--end::Input-->
                                        <!--begin::Label-->
                                ...
                                <div class="d-flex fv-row">
                                    ...
                                    <div class="form-check form-check-custom form-check-solid">
                                        <!--begin::Input-->
                                        <input class="form-check-input me-3" name="status" type="radio" value="inativo" id="kt_ecommerce_add_category_automation_0" @if($detail->status === 'inativo') checked="checked" @endif disabled>
                                        <!--end::Input-->
                                        <!--begin::Label-->
                    ...
                    <div class="d-flex justify-content-end">
                        <!--begin::Button-->
                        <a href="{{ route('painel.planos.detalhes.index') }}" class="btn btn-light me-5">Voltar</a>
                        <!--end::Button-->
                        <!--begin::Button-->
                        <a href="{{ route('painel.planos.detalhes.edit', $detail->slug) }}" class="btn btn-warning me-5">Editar</a>
                        <!--end::Button-->
                    </div>
                </div>
                <!--end::Main column-->
