						...
						<div class="card card-xxl-stretch mb-xl-8">
							...
							<div class="card-header border-0 py-5">
								<h3 class="card-title align-items-start flex-column">
									...
									<span class="text-muted fw-bold fs-7">Últimas vendas</span>
								</h3>
								...
								<div class="mt-5">
									...
									<div class="d-flex flex-stack mb-5">
										...
										<div class="d-flex align-items-center me-2">
											...
											<div class="symbol symbol-50px me-3">
												<img src="{{ URL::asset('media/avatars/150-1.jpg') }}" class="h-50" alt="" />
											</div>
											<!--end::Symbol-->
											<!--begin::Title-->
											<div>
												<a href="#" class="fs-6 text-gray-800 text-hover-primary fw-bolder">Top vendas</a>
												<div class="fs-7 text-muted fw-bold mt-1">Sandra Mett</div>
											</div>
											<!--end::Title-->
										</div>
										<!--end::Section-->
										<!--begin::Label-->
										<div class="badge badge-light text-success fw-bold py-4 px-3">+8.235$</div>
										<!--end::Label-->
									</div>
									<!--end::Item-->
									<!--begin::Item-->
									<div class="d-flex flex-stack mb-5">
										...
										<div class="d-flex align-items-center me-2">
											<!--begin::Symbol-->
											<div class="symbol symbol-50px me-3">
												<img src="{{ URL::asset('media/avatars/150-4.jpg') }}" class="h-50" alt="" />
											</div>
											<!--end::Symbol-->
											<!--begin::Title-->
											<div>
												<a href="#" class="fs-6 text-gray-800 text-hover-primary fw-bolder">Top operacional</a>
												<div class="fs-7 text-muted fw-bold mt-1">Ricky Hunt</div>
											</div>
											<!--end::Title-->
										</div>
										<!--end::Section-->
										<!--begin::Label-->
										<div class="badge badge-light fw-bold py-4 px-3">+5 cadastros na plataforma NoZap</div>
										<!--end::Label-->
									</div>
									<!--end::Item-->
								</div>
